...
<head>
    ...
    <body style = "height: 100vh; display: flex; flex-direction: column;">
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../iletisim.html">İlgi alanlarım</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../ilgi.html">İletişim sayfası</a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <section style = "height: 100%; display: flex; text-align: center; justify-content: center; flex-direction: column;">
            <div class="container">
                <?php if ($_POST["mail"] == "b221210552@sakarya.edu.tr" && $_POST["pass"] == "b221210552") {
